...
Source: "transmisor32.bat"; DestDir: "{app}";

[Tasks]
Name: "desktopicon"; Description: "{cm:CreateDesktopIcon}"; GroupDescription: "{cm:AdditionalIcons}"

[Icons]
Name: "{group}\transmisor"; Filename: "{app}\transmisor32.bat";IconFilename: "{app}\transmisor.ico"
Name: "{commondesktop}\transmisor"; Filename: "{app}\transmisor32.bat"; Tasks: desktopicon ; IconFilename: "{app}\transmisor.ico"
...
[Run]
Filename: "{app}\transmisor32.bat"; Flags: nowait postinstall skipifsilent
